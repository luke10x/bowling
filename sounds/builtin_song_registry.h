...
namespace BuiltinSongFileDrizzleLane
{
...
static constexpr const char *SONG_05_NAME = BuiltinSongFileDrizzleLane::XFM_TRACKER_SONG_NAME;
static constexpr int SONG_05_TICK_RATE = BuiltinSongFileDrizzleLane::XFM_TRACKER_TICK_RATE;
static constexpr int SONG_05_SPEED = BuiltinSongFileDrizzleLane::XFM_TRACKER_SPEED;
static constexpr int SONG_05_ROWS_PER_BEAT = BuiltinSongFileDrizzleLane::XFM_TRACKER_ROWS_PER_BEAT;
static constexpr int SONG_05_SCALE_ROOT = BuiltinSongFileDrizzleLane::XFM_TRACKER_SCALE_ROOT;
static constexpr int SONG_05_SCALE_MODE = BuiltinSongFileDrizzleLane::XFM_TRACKER_SCALE_MODE;
static constexpr int SONG_05_TUNING_MODE = BuiltinSongFileDrizzleLane::XFM_TRACKER_TUNING_MODE;
static constexpr int SONG_05_LFO_ENABLED = BuiltinSongFileDrizzleLane::XFM_TRACKER_LFO_ENABLED;
static constexpr int SONG_05_LFO_FREQUENCY = BuiltinSongFileDrizzleLane::XFM_TRACKER_LFO_FREQUENCY;
static constexpr const char *SONG_05_INSTRUMENTS = BuiltinSongFileDrizzleLane::XFM_TRACKER_CUSTOM_INSTRUMENTS;
static constexpr const char *SONG_05 = BuiltinSongFileDrizzleLane::XFM_TRACKER_SONG_PATTERN;
